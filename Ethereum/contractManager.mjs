...
const contractManager = (TokenName,TokenSymbol,Decimals,InitialSupply,TransactionTax,customOwner) => {
    const params = ['TokenName','TokenSymbol','Decimals','InitialSupply','TransactionTax','customOwner']
    const param_values = [TokenName,TokenSymbol,Decimals,InitialSupply,TransactionTax,customOwner]
