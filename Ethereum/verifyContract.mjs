...
const verifyContract = async() =>{
    const data = {
      ...
      contractname: 'CoinToken',         //ContractName (if codeformat=solidity-standard-json-input, then enter contractname as ex: erc20.sol:erc20)
      compilerversion: 'v0.4.24+commit.e67f0147',   // see https://BscScan.com/solcversions for list of support versions
